                    ...
                    <>
                        <div className="mx-auto max-w-7xl">
                            <div className="relative flex h-16 items-center justify-between">
                                ...
                                <ToggleButton /> {/* Dark mode toggle button */}
                                <div className='flex gap-2'>
                                    <div onClick={handleLogOut} className='cursor-pointer'>
                                        <span className='dark:hover:border-gray-700 dark:border-black border-gray-400 border-2 rounded-md sm:px-3 px-1.5 sm:py-2 py-1 text-sm font-medium hover:border-2 hover:border-black'>
                                            {!localStorage.getItem('authToken') ? "LogIn/SignUp" : "Log out"}
                                        </span>
                                    </div>
                                </div>
                            </div>
